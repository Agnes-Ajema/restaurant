...
export default function Home() {
  ...
  return (
    <main>
      ...
      <div className="flex bg-[#FFF] items-center justify-between p-10">
  ...
  <div className="flex justify-center">
    <img src="/images/chicken.png" className="w-[600px] h-auto rounded-lg shadow-lg" />
  </div>
</div>
      <br></br><br></br>
  ...
  <div className="bg-white shadow-lg rounded-lg p-4 m-4 max-w-xs text-center">
    <img src="/images/pepper.png" className="rounded-lg mb-2" />
    ...
    <button className="bg-yellow-500 text-neutral-100 min-w-[140px] min-h-[40px] text-[15px] rounded-lg hover:bg-yellow-600 transition duration-300">
      Add to Cart $696</button>
  </div>
  <div className="bg-white shadow-lg rounded-lg p-4 m-4 max-w-xs text-center">
    <img src="/images/chips.png" className="rounded-lg mb-2" />
    <h1 className="text-lg font-semibold mb-1">Fruit dish</h1>
    <p className="text-gray-600 mb-1">Dinko Food</p>
    <p className="text-yellow-500 mb-2">&#11088;&#11088;&#11088;&#11088;&#11088;</p>
    <button className="bg-yellow-500 text-neutral-100 min-w-[140px] min-h-[40px] text-[15px] rounded-lg hover:bg-yellow-600 transition duration-300">
  ...
  <div className="bg-white shadow-lg rounded-lg p-4 m-4 max-w-xs text-center">
    <img src="/images/pizza.png" className="rounded-lg mb-2" />
  ...
  <div className="bg-white shadow-lg rounded-lg p-4 m-4 max-w-xs text-center">
    <img src="/images/meat.png" className="rounded-lg mb-2" />
    <h1 className="text-lg font-semibold mb-1">Sea fish dish</h1>
    <p className="text-gray-600 mb-1">Dinko Food</p>
    <p className="text-yellow-500 mb-2">&#11088;&#11088;&#11088;&#11088;&#11088;</p>
...
<div className="flex ml-60 gap-10 p-10 bg-[#FFF9EF] rounded-lg">
  <div className="flex flex-col items-center">
    ...
    <div className="text-center">
      <img src="/images/hamburger.png" className="w-48 h-auto rounded-lg shadow-md transition-transform transform hover:scale-105" />
    </div>
  </div>
  ...
  <div className="flex flex-col items-center">
    ...
    <div>
      <img src="/images/map.png" className="w-48 h-auto rounded-lg shadow-md transition-transform transform hover:scale-105" />
    </div>
  </div>
</div>
      <div>
        <h1 className="text-center  font-bold text-4xl mt-[10%] ">Our Service</h1>
      </div>
      <div className="flex ml-60 gap-60">
        <div>
      ...
      <div className="text-center mt-[10%] ">
        ...
        <img src="images/quotes.png" alt="" className="justify-center mx-[850px]"/>
        <p className="w-8/12 pl-80 mx-[110px]">Lorem ipsum dolor sit amaet,consecteur adipiscing elit,sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Ut enim ad minim veniam,quis nostrud exercitation uliamco laboris nisi ut aliquip ex ea commodo</p>
      </div>
      <div className="flex pl-80 gap-10 mx-[110px]">
      <div>
        <img src="/images/girl.png"className="w-40 "/>
      </div>
      <div>
        <img src="/images/man-blue.png" className="w-40"/>
      </div>
      <div>
      ...
      <div className="flex pl-60 gap-60 bg-[#FFF9EF] mt-[10%] ">
        <div>
  ...
  <div className="flex gap-4">
    ...
    <button className="bg-black text-white min-w-[200px] min-h-[65px] text-[20px] rounded-lg hover:bg-gray-800 transition duration-300">
      ...
      <div className="flex pl-60 bg-[#FFF9EF] mt-[10%] " >
        <div>
